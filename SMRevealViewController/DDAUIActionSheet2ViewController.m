...
@interface DDAUIActionSheet2ViewController () <UIGestureRecognizerDelegate>

@property(nonatomic) IBOutlet UIView *actionSheetView;

@end

@implementation DDAUIActionSheet2ViewController
...
- (IBAction)buttonAction:(UIButton *)sender {
    [self slideOut];
    [self.delegate didSelectReason:sender.titleLabel.text];
}
